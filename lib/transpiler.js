...
function ArrowLambdaExpression(node) {
	...
	return protogen.createFunctionExpression(
		...
		node.generator, node.lexicalThis
	);
}
...
function FunctionExpression(node, scope) {
	...
	if (node.generator)
		throw new Error('Unimplemented: generators');
...
function NewExpression(node) {
	...
	return toProtoCall('New', [ proto ].concat(args));
}
...
function YieldExpression(node) {
	throw new Error('Unimplemented "YieldExpression"');
}
